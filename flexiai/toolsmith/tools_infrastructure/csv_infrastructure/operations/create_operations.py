# FILE: flexiai/toolsmith/tools_infrastructure/csv_infrastructure/operations/create_operations.py
...
from flexiai.toolsmith.tools_infrastructure.csv_infrastructure.utils.file_handler import get_full_path
