# FILE: flexiai/toolsmith/tools_infrastructure/csv_infrastructure/utils/file_handler.py

import os
from flexiai.toolsmith.tools_infrastructure.csv_infrastructure.exceptions.csv_exceptions import (
